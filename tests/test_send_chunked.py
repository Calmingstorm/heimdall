...
from src.discord.client import AnsiblexBot, DISCORD_MAX_LEN  # noqa: E402
...
def _make_bot_and_message():
    ...
    bot = MagicMock(spec=AnsiblexBot)
    # Wire up the real _send_chunked method (unbound) to the stub
    bot._send_chunked = AnsiblexBot._send_chunked.__get__(bot)
