...
class TestSystemInvariants:
    ...
    def test_tool_count_is_73(self):
        """Total tool count should be 73 (67 base + 6 agent tools)."""
        assert len(TOOLS) == 73
    ...
    def test_core_tool_count_is_53(self):
        """53 core tools always available (47 base + 6 agent tools)."""
