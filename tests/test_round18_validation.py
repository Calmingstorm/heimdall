...
class TestSystemInvariants:
    ...
    def test_tool_count_is_77(self):
        """Total tool count should be 77 (67 base + 6 agent + 2 loop-agent bridge + 2 skill toggle tools)."""
        assert len(TOOLS) == 77
    ...
    def test_core_tool_count_is_57(self):
        """57 core tools always available (47 base + 6 agent + 2 loop-agent bridge + 2 skill toggle tools)."""
